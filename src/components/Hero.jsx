    ...
    return (
        <div className="max-w-lg h-screen mx-auto mt-32">
            ...
            <div className="flex flex-col justify-around">
                <div className="mt-6 text-negro text-sm w-3/5 p-2 mx-auto shadow-lg shadow-gris font-titulos font-medium text-left max-w-sm bg-verdeClaro">
            ...
            <Link to='/crear-cuenta' className="flex justify-end m-12 p-2 px-3 w-fit mx-auto text-blanco font-titulos font-regular bg-negro border-negro border-2 rounded-lg hover:bg-blanco hover:text-negro duration-200">Crear Cuenta</Link>
        </div>
    )
}
